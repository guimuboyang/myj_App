	...
	<view class="forget">
		...
		<view class="content">
			...
			<view class="main">
				...
				<wInput v-model="loginForm.username" type="text" maxlength="11" placeholder="手机号/用户名"></wInput>
				<wInput v-model="loginForm.password" type="password" placeholder="密码"></wInput>
			...
			<!-- 底部信息 -->
			<view class="footer">
				<navigator url="login" open-type="navigate">验证码登录</navigator>
				<!-- 				<text>|</text>
